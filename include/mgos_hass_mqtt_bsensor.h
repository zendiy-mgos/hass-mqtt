...
/*
 * Home Assistant | MQTT binary sensors library.
 */

#ifndef MGOS_HASS_MQTT_BINARY_SENSOR_H
#define MGOS_HASS_MQTT_BINARY_SENSOR_H

#include <stdbool.h>
#include "mgos_hass.h"
#include "mgos_hass_bsensor.h"
...
#define MK_HA_MQTT_BSENSOR_CFG(void) {MK_HA_BASE_PUB_CFG(), MK_HA_BSENSOR_CFG(), MK_HA_MQTT_BASE_SENSOR_CFG()}
...
#endif /* MGOS_HASS_MQTT_BINARY_SENSOR_H */
